...
namespace SAVCNG_ExcelDNA
{
    public partial class FrmValidaciones : Form
    {
        ...
        private void btnBloqueo_Click(object sender, EventArgs e)
        {
            ...
            // 3. Inyección de dependencias (Pasamos el año) y ejecución aislada
            SAVCNG_ExcelDNA.Utilidades.IOperacionLibro servicioProteccion = new SAVCNG_ExcelDNA.Utilidades.ProtegerLibroService(anioSeleccionado);
            servicioProteccion.Ejecutar(excelApp, _libroCenso);
        }
        ...
        private void btnDesbloqueo_Click(object sender, EventArgs e)
        {
            ...
            // 3. Inyección de dependencias (Pasamos el año) y ejecución aislada
            SAVCNG_ExcelDNA.Utilidades.IOperacionLibro servicioDesproteccion = new SAVCNG_ExcelDNA.Utilidades.DesprotegerLibroService(anioSeleccionado);
            servicioDesproteccion.Ejecutar(excelApp, _libroCenso);
        }
        ...
        {
            // 1. Validaciones puras de UI (Dumb View)
            if (_libroCenso == null)
            {
                MessageBox.Show(this, "No hay ningún censo cargado en memoria.", "Operación Denegada", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                return;
            ...
            // 3. Inyección y ejecución del servicio aislado
            SAVCNG_ExcelDNA.Utilidades.IOperacionLibro servicioColorimetria = new SAVCNG_ExcelDNA.Utilidades.AplicarColoresService();
            servicioColorimetria.Ejecutar(excelApp, _libroCenso);
        }
